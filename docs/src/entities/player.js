...
export class Player {
  ...
  draw(ctx, p, input, now){
    ...
    // outfit overrides (cosmetic only)
    const outfit = (p && p.outfit) ? String(p.outfit) : "street";
    if (outfit === "sport"){
      C.shirt1 = "#2f6fb1"; C.shirt2 = "#22568b"; C.shirt3 = "#1c466f";
      C.pants  = "#2b2f3a";
      C.hair   = "#2b1a20";
    } else if (outfit === "formal"){
      C.shirt1 = "#1f1f24"; C.shirt2 = "#2b2b34"; C.shirt3 = "#3a3a46";
      C.pants  = "#111116";
      C.hair   = "#2a2426";
    } else if (outfit === "rebel"){
      C.shirt1 = "#8a2eff"; C.shirt2 = "#5b1bb3"; C.shirt3 = "#3b0a6e";
      C.pants  = "#1f1a2a";
      C.glow   = "#8a2eff";
    }
;
